...
return new class extends Migration
{
    ...
    {
        Schema::create('ht_tbl_AdminWebMenu', function (Blueprint $table) {
            $table->increments('IdMenuAdmin');
            ...
            $table->string('IdName', 50)->nullable();
    ...
    {
        Schema::dropIfExists('ht_tbl_AdminWebMenu');
    }
};
