                ...
                <div class="col-lg-12 col-md-12" style="margin: 0 auto;">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="/admin/settings/infomation/created" method="post" class="row"
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    ...
                                                    <div class="input-group has-validation">
                                                        <input type="text" name="ResName" class="form-control"
                                                            ...
                                                            oninput="onInput(event)" value="{{ old('ResName') }}">
                                                        @if ($errors->any())
                                        ...
                                        <div class="col-lg-4 mb-3">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="text" name="OpeningDay" class="form-control" id="OpeningDay"
                                                    placeholder="VD: Thứ 2 - CN" value="{{ old('OpeningDay') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            ...
                                            <textarea name="LongDescription" id="summernote" style="width: 100% !important; "> </textarea>
                                        </div>
