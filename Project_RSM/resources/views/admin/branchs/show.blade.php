        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-lg-10 col-xl-10 mx-auto">
                    <div class="pagetitle">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Thông tin cơ sở: {{ $Branch->BranchName }}
                                </li>
                            </ol>
                        </nav>
                    </div><!-- End Page Title -->
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="/admin/branchs/{{ $Branch->IdBranch }}"
                                enctype="multipart/form-data" onsubmit="return CheckInfoBranch()">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="tab-pane fade show active" id="bordered-justified-home" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="text" name="BranchName" class="form-control"
                                                        value="{{ $Branch->BranchName }}" id="BranchName"
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="text" name="PhoneNumber" value="{{ $Branch->PhoneNumber }}"
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="text" name="Email" class="form-control"
                                                        ...
                                                        oninput="onInput(event)" value="{{ $Branch->Email }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 mb-3">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="text" name="Description" class="form-control" id="" value="{{ $Branch->Description }}">
                                                </div>
                                            </div>
                                        </div>
                                        {{-- <div class="col-lg-12 mb-3 border-top-line">
                                            @if (!$listItems->isEmpty())
                                                <p class="form-label mb-3">Danh sách các mặt hàng thuộc cơ sở</p>
                                            ...
                                            @else
                                                <div class="text-center">
                                                    ...
                                                    <p class="fs-6 pt-3 m-0">Chưa có mặt hàng nào thuộc cơ sở này</p>
                                                    </p>
                                                </div>
                                            @endif
                                        </div> --}}
                                ...
                                <div class="group border-top-line" style="display: flex; justify-content: space-between;">
                                    ...
                                    <button onclick="CheckInfoBranch()" autocomplete="off" type="submit"
                ...
                <div class="d-flex container" style=" width: auto; max-width: 70%; align-items: center;">
                    <div class="bg0 p-lr-15-lg how-pos3-parent"
                        ...
                        <div class="text-danger mb-3" style="text-align: left; font-size: 18px;">Bạn
                            chắc chắn muốn xóa cơ sở <strong> {{ $Branch->BranchName }}</strong> ?</div>
                        ...
                        <div class="m-t-32">
                            <div class="col-sm-12 d-flex" style="padding: 0; justify-content: flex-end;">
                                ...
                                <a href="/admin/branchs/delete/{{ $Branch->IdBranch }}"
