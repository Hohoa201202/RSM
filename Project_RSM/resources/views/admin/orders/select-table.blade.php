                    ...
                    <div class="pagetitle">
                        <nav>
                            <ol class="breadcrumb" style="justify-content: space-between;">
                                <h4 class="breadcrumb-item active">Chuyển bàn</h4>
                            </ol>
                        </nav>
                    </div><!-- End Page Title -->
                    <div class="row">
                                                        ...
                                                        <div class="col col-lg-3 col-md-4 mb-4" data-aos="zoom-in"
                                                            ...
                                                            <a class="position-relative"
                                                                @if ($table->IdStatus === 1) {{-- Trống --}}
                                                                    ...
                                                                    href="{{ route('orders-selected-table', ['IdTable' => $table->IdTable, 'IdOrder' => $order->IdOrder]) }}"
                                                                    @else
                                                                ...
                                                                <div class="d-flex d-flex flex-column align-items-center form-setting">
                                                                    ...
                                                                    <div class="border-top-line w-100 pt-2">
                                                                        <p class="m-0">{{ $table->TypeName . " (Tối đa ". $table->MaxSeats .")" }}</p>
                                                                    </div>
                                                                </div>
                                                                @if ($table->IdTable === $order->IdTable)
