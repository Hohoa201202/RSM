                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">Quản trị nhà hàng</span>
                                </a>
                            </div><!-- End Logo -->

                            <div class="card mb-3">

                                <div class="card-body" style="padding: 0 32px 20px 32px">
                                    ...
                                    <form action="{{ URL::to('/admin/login.html') }}" method="POST"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="text" name="UserName" class="form-control"
                                                    id="yourUsername" required placeholder="Username...">
                                        ...
                                        <div class="col-12">
                                            <div style="position: relative;" class="form-check">
                                                ...
                                                <a style="position: absolute; right: 0;" class="form-check-label"
                                                    for="rememberMe">Quên mật khẩu?</a>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            @foreach ($errors->all() as $error)
                                                <p class="text-danger text-center" style="font-style:italic; letter-spacing: 1px;">
                                                    {{ $error }}</p>
                                            @endforeach
                                        </div>
                                    </form>
